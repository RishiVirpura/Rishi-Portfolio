...
export const About = () => {
  ...
  const Languages = ["Python", "R", "HTML", "CSS", "C", "Javascript", "Java"];
    ...
    >
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <p className="text-violet-100 mb-6">
              I am currently applying for internships, and am planning to continue my graduate studies at Northeastern University!
          ...
          <div className="rounded-xl p-8 border-white/10 border hover:-translate-y-1 transition-all">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="rounded-xl p-6 hover:-translate-y-1 transition-all">
                <h3 className="text-xl text-violet-100 font-bold mb-4"> Certifications</h3>
                <div className="flex flex-wrap gap-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <strong> Bachelor of Science in Computer Science and Engineering </strong> - University of Connecticut
                ...
                <div>
              <strong> Master of Science in Computer Science </strong> - Northeastern University
                  (2026-2028)
                  <ul className="list-disc list-inside text-gray-300 space-y-4">
                  <li>
                <strong>Relevant Coursework:</strong> Programming Design Paradigm, Database Management Systems
                </li>
                </ul>
                </div>
                </div>
            ...
            <div className="p-6 rounded-xl border-white/10 border hover:-translate-y-1 transition-all">
              ...
              <div className="space-y-4 text-gray-300">
                ...
                <div>
                  <h4 className="font-semibold">
                    {" "}
                    Technical Instructor at The Coder School (September 2025 - August 2026){" "}
                  </h4>
                  <p>
                  Served as the primary technical resource for 20+ K12 students per week, resolving coding errors through systematic troubleshooting and communicating solutions clearly to clients (parents and students).
                  </p>
                </div>
